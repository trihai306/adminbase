...
return [
    ...
    'enum_value'           => 'Trường :attribute không hợp lệ.',
    'phone_number'         => 'Trường :attribute phải là một số điện thoại hợp lệ.',
    'mobile_card_serial'   => 'Trường :attribute phải là một số sê-ri điện thoại hợp lệ.',
    'mobile_card_code'     => 'Trường :attribute phải là một mã điện thoại hợp lệ.',
    'message_body'         => 'Trường :attribute không hợp lệ.',
    'custom'               => [
        'attribute-name' => [
